...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('auction', '0021_auto_20181023_1957'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='auction',
            name='price',
            field=djmoney.models.fields.MoneyField(decimal_places=0, default=Decimal('0.0'), default_currency='EUR', max_digits=14, verbose_name='Minimum Price'),
        ),
        migrations.AlterField(
            model_name='auction',
            name='price_currency',
